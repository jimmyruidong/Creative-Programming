[ note, this folder contains just some of the MOBY lists – for a full selection, see http://www.gutenberg.org/ebooks/3201 ]
...
3) On the PG Catalog page listing click on "More Files". You will see a
"files.zip" folder in the list. Copy this zipped folder to your computer.
Open "files.zip" and copy the contents  into the  destination directory on
your computer.
